"""Script to perform student-teacher distillation with transformer for FR3 Agilehand"""
...
def main(env_cfg, agent_cfg: dict):
    ...
    if args_cli.teacher is not None:
        ...
        teacher_ckpt = "pretrained_ckpts/fr3_agilehand_teacher.pth"
    ...
    dagger.distill()
    if rank == 0:
        dagger.save("fr3_agilehand_student_transformer_final")
